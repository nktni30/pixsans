                ...
                <div className="row">
                    <div className="col-md-7 col-sm-6 ">
                        <div className="row mt-md-5 text-center text-md-start"> 
                                ...
                                <h1 className="nkt-teal nkt-banner-font ">Our<br /><span className="nkt-orange">Services</span></h1>
                                <p className="nkt-font mt-md-5 mt-1">We provide many serivces for your entrepreneur</p>
                    ...
                    <div className="col-md-5 order-first order-md-last col-sm-6">
                        <img className="ban-img" src={ServiceBanImg} />
                    </div>
                </div>
            </div>
        </>
