                ...
                <div className="row">
                    <div className="col-md-7 col-sm-6 ">
                        <div className="row mt-md-5 text-center text-md-start"> 
                                ...
                                <h1 className="nkt-teal nkt-banner-font ">Welcome to Zone<br /> of <span className="nkt-orange">Graphics</span></h1>
                                <p className="nkt-font mt-md-5 mt-1">Its a freelance graphics coummunity for entrepreneur</p>
                                <p className="nkt-font mt-md-4">Our creative graphic designing services includes
